...
var getVisibleHelpers = (0, _reselect.createSelector)(function (_ref) {
  ...
  return helpers && helpers.filter(function (helper) {
    return helper.pathname === pathname;
  });
});

var PartContent = exports.PartContent = function PartContent(WrappedComponent) {
  var _PartContent = function (_Component) {
    _inherits(_PartContent, _Component);

    function _PartContent() {
      _classCallCheck(this, _PartContent);

      var _this = _possibleConstructorReturn(this, (_PartContent.__proto__ || Object.getPrototypeOf(_PartContent)).call(this));
    ...
    _createClass(_PartContent, [{
      ...
      value: function _handleStepUpdate(props, helperIndex) {
        ...
        var nextSearch = (0, _transactionsReduxReact.getUpdatedSearchString)(search, {
  ...
  return (0, _reactRedux.connect)(function (state, ownProps) {
    ...
    var visibleHelpers = getVisibleHelpers(state, ownProps);
  ...
  }, { push: _reactRouterRedux.push })(_PartContent);
};